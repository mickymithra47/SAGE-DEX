...
contract Permit2CoreTest is Test {
    ...
    function setUp() public {
        ...
        // Alice gives standard unlimited approval to Permit2 contract
        vm.prank(alice);
        token.approve(address(permit2), type(uint256).max);
    }

    function test_Permit2_SignatureTransferFrom() public {
        ...
        // Spender executes permit transfer
        vm.prank(spender);
